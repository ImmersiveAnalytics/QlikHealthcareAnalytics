...
namespace ChartAndGraph
{
    ...
    class CanvasChartMesh : ChartMeshBase
    {
        ...
        public override void AddText(AnyChart chart, Text prefab, Transform parentTransform, int fontSize,float fontScale, string text, float x, float y, float z,float angle, object userData)
        {
            if(mTextOnly)
                base.AddText(chart, prefab, parentTransform, fontSize,fontScale, text, x, y, z,angle, userData);
        }
