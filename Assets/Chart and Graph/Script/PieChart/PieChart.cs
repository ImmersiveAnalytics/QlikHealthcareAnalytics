...
namespace ChartAndGraph
{
    ...
    [ExecuteInEditMode]
    [Serializable]
    public abstract class PieChart : AnyChart, ISerializationCallbackReceiver
    {
        ...
        /// </summary>
        public PieEvent PieClicked;
        
        /// <summary>
        /// occures when a pie item is hovered
        /// </summary>
        public PieEvent PieHovered;
        ...
        protected abstract float DepthLink
        {
            get;
        }
        ...
        Vector3 AlignTextPosition(AlignedItemLabels labels,PieObject obj,out CanvasLines.LineSegement line,float modifiedRaidus)
        {
            ...
            if (labels.Alignment == ChartLabelAlignment.Top)
            {
                ...
                line = new CanvasLines.LineSegement(new Vector3[] { basePosition, end });
            }
            ...
            for (int i = 0; i < columnCount; ++i)
            {
                ...
                if (mPies.TryGetValue(name, out dataObject))
                {
                    ...
                    if (dataObject.ItemLabel)
                    {
                        ...
                        dataObject.ItemLabel.UIText.text = toSet;
                ...
                else
                {
                    ...
                    if (mItemLabels != null)
                    {
                        ...
                        string toSet = ChartAdancedSettings.Instance.FormatFractionDigits(mItemLabels.FractionDigits, amount);
                        toSet = mItemLabels.TextFormat.Format(toSet, name, "");
                        BillboardText billboard = ChartCommon.CreateBillboardText(mItemLabels.TextPrefab, topObject.transform, toSet, labelPos.x, labelPos.y, labelPos.z,lineAngle, transform, hideHierarchy, mItemLabels.FontSize, mItemLabels.FontSharpness);
                    ...
                    if (mCategoryLabels != null)
                    {
                        ...
                        BillboardText billboard = ChartCommon.CreateBillboardText(mCategoryLabels.TextPrefab, topObject.transform, toSet, labelPos.x, labelPos.y, labelPos.z, lineAngle,transform, hideHierarchy, mCategoryLabels.FontSize, mCategoryLabels.FontSharpness);
                ...
                generator.Generate(Mathf.Deg2Rad * start, Mathf.Deg2Rad * currentSpan, modifiedRadius, torusRadius, meshSegements, DepthLink);
        ...
        {
            ((IInternalPieData)Data).OnBeforeSerialize();
        }

        public void OnAfterDeserialize()
        {
            ((IInternalPieData)Data).OnAfterDeserialize();
        }
        ...
        protected override void OnItemSelected(object userData)
        {
            ...
            if(PieClicked != null)
                PieClicked.Invoke(userDataToEventArgs(userData));
        }
