...
namespace ChartAndGraph
{
    ...
    class WorldSpacePieGenerator : MonoBehaviour,IPieGenerator
    {
        ...
        public void Generate(float startAngle, float angleSpan, float radius, float innerRadius, int segments, float depth)
        {
            ...
            if(depth<=0f)
                ...
                PieMesh.Generate3dMesh(mesh, startAngle, angleSpan, radius, innerRadius, segments, depth);
