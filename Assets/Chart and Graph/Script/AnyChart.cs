...
namespace ChartAndGraph
{
    ...
    public abstract class AnyChart : MonoBehaviour, IInternalUse
    {
        ...
        internal protected virtual IAxisGenerator InternalGenerateAxis(AxisBase axisBase, ChartOrientation axisOrientation, bool isSubDiv)
        {
            ...
            res.SetAxis(this, axisBase, axisOrientation, isSubDiv);
        ...
        protected void GenerateAxis()
        {
            if (mVerticalAxis)
            {
                IAxisGenerator main = InternalGenerateAxis(mVerticalAxis, ChartOrientation.Vertical, false);
                IAxisGenerator sub = InternalGenerateAxis(mVerticalAxis, ChartOrientation.Vertical, true);
                if (main != null)
                    mAxis.Add(main);
                if (sub != null)
                    mAxis.Add(sub);
            ...
            if (mHorizontalAxis)
            {
                IAxisGenerator main = InternalGenerateAxis(mHorizontalAxis, ChartOrientation.Horizontal, false);
                IAxisGenerator sub = InternalGenerateAxis(mHorizontalAxis, ChartOrientation.Horizontal, true);
                if (main != null)
                    mAxis.Add(main);
                if (sub != null)
                    mAxis.Add(sub);
