...
{
    [Serializable]
    public class RadarChartData : AbstractChartData, IInternalRadarData
    {
        [Serializable]
        ...
        void IInternalRadarData.Update()
        {
            UpdateSliders();
        }
        ...
        void IInternalRadarData.OnBeforeSerialize()
        {
        ...
        void IInternalRadarData.OnAfterDeserialize()
        {
